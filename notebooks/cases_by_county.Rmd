...
library(ggplot2)
trjplt1 <- ggplot(data = daily_cases_cty, aes(x = date, y = cases_100k, color = attribute)) + 
    geom_line(size = 0.75) +
...
trjplt2 <- ggplot(data = daily_cases_cty, aes(x = date, y = cases_100k, color = attribute)) + 
    geom_line(size = 0.75) +
    facet_wrap(~attribute) +
    scale_y_log10() +
    xlab('Date') +
