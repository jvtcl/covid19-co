...
```{r daily-cases-100k, fig.height = 12, fig.width = 12}
library(ggplot2)
...
## Smoothed Raw Cases per 100,000 people by cluster with variable y-axes

```{r county-clusters-smooth-raw, fig.height = 13, fig.width = 8}
cowplot::plot_grid(mapplot, trjplot, ncol = 1)
```

## Smoothed Log-transformed Cases per 100,000 people by cluster with fixed y-axes

```{r county-clusters-smooth-log, fig.height = 13, fig.width = 8}
